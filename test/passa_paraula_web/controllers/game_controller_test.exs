defmodule PassaParaulaWeb.GameControllerTest do
  use PassaParaulaWeb.ConnCase

  import PassaParaula.GamesFixtures

  @create_attrs %{code: "some code", status: "some status"}
  @update_attrs %{code: "some updated code", status: "some updated status"}
