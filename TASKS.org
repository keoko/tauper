#+title: Tasks
* Tasks
** TODO start game / waiting to start the game / player already in game
** TODO display if it worked/failed in player window -> me lo ha contado bien o mal,
** TODO display answer in scoring page
** TODO running out of time
** TODO oxidation_states are wrong
** DONE oxidation_states questions are not generated
** TODO not sensitive to lowercase/uppercase
** DONE display number of answers in started mode
** TODO only owner can view the games/show page
** TODO remove special elements
...
** DONE display number of question? remaining questions?
