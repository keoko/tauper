#+title: Tasks
* Tasks
** TODO display users in rows instead of bulleted lists
** TODO removed special elements
** TODO configure time per question
** redirect to join page does not work
...
** YES remove game actions not needed (edit game, etc.)
...
** display number of question? remaining questions?
** display number of answers in started mode
** list_games
