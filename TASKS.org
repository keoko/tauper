...
* Tasks
** DONE styling
** TODO Score: X points ( answered ) not translated to catalan
** TODO Style game-status section
** TODO score alignment
** TODO review CSS (add variables)
** TODO buttons actions always aligned to the right?
** TODO replace jugador: owner with something alone.
** DONE beril.li
