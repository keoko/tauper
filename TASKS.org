#+title: Tasks
* Tasks
** join page button actions not aligned
** KILL email
** DONE stop game on solo mode, maybe translated to continue button?
** DONE styling
** DONE Score: X points ( answered ) not translated to catalan
** DONE Style game-status section
** DONE score alignment
** TODO review CSS (add variables)
** DONE buttons actions always aligned to the right?
** DONE replace jugador: owner with something alone.
** DONE beril.li
** TODO build properly periodic table
** DONE improve UI how to play alone / how to create a game
** DONE only owner can view the games/show page
** TODO create error page with a link to the homepage (e.g. forbidden error whe going back in a form)
** DONE add link to go to the homepage in TauPer header
** TODO migrate to Phoenix 1.7
** DONE style primary and secondary buttons (e.g. send question and next question caused confusion)
** TODO answer_form logic is duplicated in show and play LV pages
** TODO allow multiple element tables
** TODO refactor game modes (alone, multiplayer) and game states (started, paused, etc)
** DONE join back to the current game
** DONE "owner" is not a valid player name.
** DONE display time/questions answered at the top in a bar?
...
** KILL email is marked as spam
** DONE translate errors in CA
** DONE translate app error messages
